...
#define M_S A2 //ir sensor tengah
...
if((digitalRead(R_S) == 1)&&(digitalRead(L_S) == 0) && (digitalRead(M_S) == 1))
...
if((digitalRead(R_S) == 1)&&(digitalRead(L_S) == 1) && (digitalRead(M_S) == 0)){Stop();} //if Right Sensor and Left Sensor are at Black color then it will call Stop function
if((digitalRead(R_S) == 1)&&(digitalRead(L_S) == 1) && (digitalRead(M_S) == 1)){turnLeft();}
} 
